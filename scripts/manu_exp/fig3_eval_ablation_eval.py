...
@File: fig3_eval_ablation_eval.py
@Date: 2020/12/23 
@Time: 14:58
@Desc: 脚本用于根据选定的测试样本测试文章全模型表现
'''
import os
import pandas as pd
import numpy as np
...
if __name__ == '__main__':
    ...
    res_save = r'I:\20201221_Manu_Fig3\results_all'
    data_root = r'K:\liusibo\20201221_Manu_Fig3\SAMPLED_TEST_DATASET'

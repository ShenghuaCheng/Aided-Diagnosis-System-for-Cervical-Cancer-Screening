...
fold = "H:/yujingya/grad_cam/test/"
gradcam_path= "H:/yujingya/grad_cam/510/"#
listDir=os.listdir(fold)
input_model = ResNetClassification.ResNet(input_shape=(512,512,3))
input_model.load_weights("H:/weights/w_color_new/Block_50.h5")
...
# =============================================================================
#     imgBin  = BinarySP(imgcam, threColor = 28, threVol= 1000)
#     imgcam[imgBin==0]=0
# =============================================================================

...
if __name__ == "__main__":
    ...
    model1.load_weights(r'H:\weights\szsq_model1_540_pred.h5', by_name=True)
    model1.load_weights(r'H:\weights\szsq_model1_540_20_local.h5', by_name=True)
    model1.save('H:\weights\w_szsq\model1_local\pb\szsq_model1_540_20_local.h5')

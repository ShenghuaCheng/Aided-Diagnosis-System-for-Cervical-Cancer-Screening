...
weights_filelist = glob(r'F:\LiuSibo\Codes\Projects\AidedDiagnosisSystem\doc\manu_yjy\exp2\new_E\*.h5')
path_result = r'F:\LiuSibo\Codes\Projects\AidedDiagnosisSystem\doc\manu_yjy\exp2\new_E\results_123'
...
Net = ResNet(input_shape=(256, 256, 3))
...
for c in classes:
    ...
    for weights_path in weights_filelist:
        ...
        Net.load_weights(weights_path)
         # 预测及统计
        preds_prob = Net.predict(img_data, batch_size=32*gpu_num, verbose=1)

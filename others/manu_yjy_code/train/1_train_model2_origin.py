...
from read_image.dataset import DataSet
...
learning_rate = 1e-5
config_path = r'H:\yujingya\lsb_yjy\experience\1\config'
path_checkpoints = r'H:\yujingya\lsb_yjy\experience\1\weights\origin'

file_pretrain_weights = None#r'H:\weights\w_szsq_tongji34_update_190703\model2_pred\Block_1064.h5'
start = 0
end = 800#1epoch=20blocks
Frozen_layers=37

enhance_flag = {'train': False, 'vail': False}
